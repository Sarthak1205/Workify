...
class OrderSubmissionsPage extends StatefulWidget {
  final String orderId;
  const OrderSubmissionsPage({super.key, required this.orderId});

  @override
  State<OrderSubmissionsPage> createState() => _OrderSubmissionsPageState();
}

class _OrderSubmissionsPageState extends State<OrderSubmissionsPage> {
  ...
  Future<void> fetchFiles() async {
    ...
    try {
      ...
      if (userDoc.exists && userDoc.data() != null) {
        List<dynamic> urls =
            (userDoc.data() as Map<String, dynamic>)['workSubmission'] ?? [];
...
class PDFViewerScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Work Submission")),
